...
public class TestAllTasks
{
	...
	@Test
	public void scheduleMedicalTestBlood() throws UserAlreadyExistsException, InvalidNameException, InvalidLocationException, InvalidPatientFileException, InvalidSerialException, CanNeverBeScheduledException, FactoryInstantiationException 
	{
	...
	@Test
	public void scheduleTreatment() throws UserAlreadyExistsException, InvalidNameException, InvalidLocationException, InvalidPatientFileException, InvalidDiagnoseException, InvalidDoctorException, InvalidComplaintsException, FactoryInstantiationException, CanNeverBeScheduledException, WarehouseOverCapacityException
	{
		NurseFactory f= new NurseFactory();
		f.setName("Jenny");
		f.setLocation(location);
		...
		surgeryfactory.setPatientFile(file);
