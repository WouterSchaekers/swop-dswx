...
public class HospitalDate
{
	...
	public void setYear(int year) {
		this.setTime(year, this.getMonth(), this.getDay(), this.getHour(),
	...
	public void setMonth(int month) {
		this.setTime(this.getYear(), month, this.getDay(), this.getHour(),
				this.getMinute(), this.getSecond());
	}
	...
	public void setDay(int day) {
		this.setTime(this.getYear(), this.getMonth(), day, this.getHour(),
				this.getMinute(), this.getSecond());
	}
	...
	public void setHour(int hour) {
		this.setTime(this.getYear(), this.getMonth(), this.getDay(), hour,
				this.getMinute(), this.getSecond());
	}
	...
	public void setMinute(int minute) {
		this.setTime(this.getYear(), this.getMonth(), this.getDay(),
	...
	public void setTime(long millis) {
		this.gregorianCalendar.setTimeInMillis(HospitalDate.START_OF_TIME
				.getTimeSinceStart() + millis);
	}
