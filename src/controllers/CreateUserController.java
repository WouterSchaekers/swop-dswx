...
public class CreateUserController extends NeedsLoginController
{
	...
	public CreateUserController(LoginController loginController,HospitalState hospitalState) throws InvalidLoginControllerException, InvalidHospitalStateException {
	...
	public void createNurse(String nurse,LoginController l) throws UserAlreadyExistsException, InvalidNameException, InvalidTimeSlotException
	{
		if(!l.equals(loginc))
	...
	public void createDoctor(String nurse,LoginController l) throws UserAlreadyExistsException, InvalidNameException, InvalidTimeSlotException
	{
		if(!l.equals(loginc))
			throw new IllegalArgumentException("invalid login controller");
		if(!hospitalState.getUserManager().equals(manager))
