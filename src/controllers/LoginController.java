...
/**
 * This class will be used as a login controller.
 * There will be a 1:1 relation between the amount of logged in users and the amount of controllers.
 * Each logincontroller will remember what user they logged in. 
 */
public class LoginController
{
	private UserManager um; // the usermanager for this controller.
	private boolean loggedIn = false; // true if the user of this controller is logged in.
