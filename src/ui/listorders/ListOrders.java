...
public class ListOrders extends ListOrdersSuper
{
	...
	public Usecase Execute() {
		...
		while(!isValidInput){
			...
			try{
				orderedItems = listOrdersController.getCorrespondingOrderedItems(stockProvider, itemName);
				isValidInput = true;
			}
		...
		System.out.println("The 20 latest placed orders of the selected category:");
		for(int i = orderedItems.size() - 1; i > 0 && i >= orderedItems.size() - 20; i++){
