...
public class BloodAnalysisFactory extends MedicalTestFactory
{
	 ...
	 * @throws if the provided number is invalid (<=0)
	 */
	 ...
	 * @return
	 *  false if one of the fields has not been inialized or is wrongfully inialized.
	 */
	 ...
	 * @param focus
	 * 	the focus of the bloodanalysis that will be created by this factory
	 * @return
	 * 	true if the argumet is  null.
	 */
