...
public class BloodTestResult extends Result
{
	 ...
	 */
	public BloodTestResult(int amountOfBlood, int amountOfPlatelets,
			int amountOfRed, int amountOfWhite) throws InvalidReportException,
			InvalidAmountException {
		super("Bloodtest");
		if (!super.canhaveAsAmount(amountOfBlood)
				&& super.canhaveAsAmount(amountOfPlatelets)
				&& super.canhaveAsAmount(amountOfRed)
				&& super.canhaveAsAmount(amountOfWhite))
